...
#airports.info()
# you get the same if you: print(airports)
...
#print(airports["Carriers.Total"].value_counts())
...
den_delays = denver[['Delayed', 'Flights.Total', 'Year', 'Month',
                     'Month Name', 'Minutes Delayed.Weather', 'Minutes Delayed.Total']]
# print(den_delays[:5])
...
den_delays_annual['Percent Delayed'] = (den_delays_annual['Delayed']
	                                       /den_delays_annual['Flights.Total'])
...
# plt.scatter(den_delays['Minutes Delayed.Weather'],
#             den_delays['Minutes Delayed.Total'],
#             c=den_delays["Month"], cmap=plt.get_cmap("jet"))
# plt.xlabel('Minutes delayed due to Weather')
# plt.ylabel('Total Minutes Delayed')
...
# plot1 = plt.scatter(vegas['Minutes Delayed.Weather'],
#                     vegas['Minutes Delayed.Total'],
#                     c='b', label='Vegas')
# plot2 = plt.scatter(den_delays['Minutes Delayed.Weather'],
#                     den_delays['Minutes Delayed.Total'],
#                     c='r', label='Denver')
